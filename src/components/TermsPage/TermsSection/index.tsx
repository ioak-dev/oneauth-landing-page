    ...
    <div className="terms-section">
      <div className="terms-section--container column-layout">
        ...
        <p>
          ...
          conditions. Do not continue to use Oneauth if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Oneauth, you agreed to use
          cookies in agreement with the Oneauth's Privacy Policy.
        </p>
        ...
        <p>
          Unless otherwise stated, Oneauth and/or its licensors own the
          intellectual property rights for all material on Oneauth. All
          intellectual property rights are reserved. You may access this from
          Oneauth for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Oneauth</li>
          <li>Sell, rent or sub-license material from Oneauth</li>
          <li>Reproduce, duplicate or copy material from Oneauth</li>
          <li>Redistribute content from Oneauth</li>
        </ul>
        ...
        <p>
          ...
          Oneauth does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Oneauth,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Oneauth shall not be liable
        ...
        <p>
          Oneauth reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Oneauth a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Oneauth; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to Oneauth. Please include your name, your
        ...
        <p>
          No use of Oneauth's logo or other artwork will be allowed for linking
